        ...
        <li className='bg-white border-2 border-zinc-700 rounded-lg p-5 max-w-[320px]'>
            ...
            <div className='flex gap-3 pt-4 border-t border-zinc-200'>
                <button
                    ...
                    className='flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-white bg-zinc-800 hover:bg-zinc-900 rounded-lg transition-colors'
                >
                ...
                <button
                    ...
                    className='flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-red-600 hover:text-red-700 bg-red-50 hover:bg-red-100 rounded-lg transition-colors'
                >
                    <svg className='w-4 h-4' fill="none" stroke="currentColor" viewBox="0 0 24 24">
